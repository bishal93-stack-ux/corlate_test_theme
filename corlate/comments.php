...
if ( comments_open() || pings_open() ) {
	...
	comment_form(
		array(
			...
			'submit_button'      => '<button type="submit" class="btn btn-primary btn-lg" required="required">Post Comment</button>',
		)
	);
    ...
    <div class="comment-respond" id="respond">
        ...
        <p class="comments-closed"><?php _e( 'Comments are closed.', 'corlate' ); ?></p>
